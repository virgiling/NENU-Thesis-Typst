...
:::caution[更新]
模板与文档还在超绝更新中，随时有可能变化，请时刻关注

但每个发布的版本都会保留，不存在损坏问题
:::
...
从“摘要”到“在学期间取得创新性成果情况”部分采用双面印刷，A4标准纸（210mm x 297mm）打印。
...
我们需要传递 `pubs` 参数，其结构参考 [pubs 参数文档](/document/reference/pubs)
...
我们需要传递一个 `comments` 参数，结构参考 [comments 参数文档](/document/reference/comments)
